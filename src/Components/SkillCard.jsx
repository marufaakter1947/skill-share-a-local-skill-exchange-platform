  ...
  return (
    <div className="card bg-base-100   shadow-sm hover:scale-105 transition ease-in-out px-4 py-4">
      <Link to={`/skill/${skillId}`}>
        ...
        <h2 className="text-xl font-medium my-4 truncate hover:overflow-visible hover:whitespace-normal hover:text-clip">
          {skillName}
        </h2>
        ...
        <div>
          <button className="btn w-full mt-3 bg-[linear-gradient(125.07deg,#89F336,#458018)]">
            View Details
          </button>
        </div>
      </Link>
